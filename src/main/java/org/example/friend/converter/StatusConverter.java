...
public class StatusConverter implements Converter<Integer> {
    ...
    private static final String BAN = "被封禁";
    private static final String NOBAN = "未封禁";
    ...
    public Integer convertToJavaData(CellData cellData, ExcelContentProperty excelContentProperty,
        ...
        if (BAN.equals(gender)) {
            return 0;
        } else if (NOBAN.equals(gender)) {
            return 1;
        }
        return null;
    }
    ...
    public CellData<?> convertToExcelData(Integer integer, ExcelContentProperty excelContentProperty,
        ...
        if (integer == null) {
            ...
            return new CellData<>(BAN);
        } else if (integer == 1) {
            return new CellData<>(NOBAN);
        }
        return new CellData<>("");
    }
}
